...
set output "TCP_5_st_2020_10_06_16-04-51_two2one_00032B.png"
...
set autoscale xfix
plot "TCP_5_st_2020_10_06_16-04-51_two2one_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
