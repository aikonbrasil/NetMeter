...
set output "UDP_3_st_2020_10_07_18-23-36_one2two_00032B.png"

set title "{/=20 Datagram size: 32 B, Av. rate: 15.00 ms}\n\n{/=18 (LAPTOP-UE-1 to LAPTOP-UE-0, UDP, 3 st.)}"
...
set autoscale xfix
plot "UDP_3_st_2020_10_07_18-23-36_one2two_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
