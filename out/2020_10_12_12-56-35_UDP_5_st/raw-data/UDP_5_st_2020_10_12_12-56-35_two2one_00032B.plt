...
set output "UDP_5_st_2020_10_12_12-56-35_two2one_00032B.png"

set title "{/=20 Datagram size: 32 B, Av. rate: 535.43 Kb/s}\n\n{/=18 (LAPTOP-UE-5 to LAPTOP-UE-0, UDP, 5 st.)}"
...
set autoscale xfix
plot "UDP_5_st_2020_10_12_12-56-35_two2one_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
