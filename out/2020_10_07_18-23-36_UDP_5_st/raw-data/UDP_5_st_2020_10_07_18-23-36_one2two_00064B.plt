...
set output "UDP_5_st_2020_10_07_18-23-36_one2two_00064B.png"
...
set autoscale xfix
plot "UDP_5_st_2020_10_07_18-23-36_one2two_00064B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
