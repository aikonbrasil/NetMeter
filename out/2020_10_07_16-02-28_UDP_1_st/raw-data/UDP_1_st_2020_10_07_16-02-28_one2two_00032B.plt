...
set output "UDP_1_st_2020_10_07_16-02-28_one2two_00032B.png"
...
set autoscale xfix
plot "UDP_1_st_2020_10_07_16-02-28_one2two_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
