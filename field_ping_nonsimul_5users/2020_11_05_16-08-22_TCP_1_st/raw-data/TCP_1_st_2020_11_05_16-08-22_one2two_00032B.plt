...
set output "TCP_1_st_2020_11_05_16-08-22_one2two_00032B.png"

set title "{/=20 Buffer size: 32 B, Av. rate: 18.40 ms}\n\n{/=18 (LAPTOP-UE-0 to LAPTOP-UE-6, TCP, 1 st.)}"
...
set autoscale xfix
plot "TCP_1_st_2020_11_05_16-08-22_one2two_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
