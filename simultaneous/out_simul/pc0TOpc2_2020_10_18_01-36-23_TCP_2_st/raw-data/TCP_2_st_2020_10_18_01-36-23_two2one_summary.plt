...
set output "TCP_2_st_2020_10_18_01-36-23_two2one_summary.png"

set title "{/=20 Bandwidth \\& CPU usage for different packet sizes}\n\n{/=18 (LAPTOP-UE-1 to LAPTOP-UE-0, TCP, 2 st.)}"
...
stats "TCP_2_st_2020_10_18_01-36-23_two2one_iperf_summary.dat" using ($1 >= 0 ? $3 : 1/0) nooutput
set logscale x 2
set style fill transparent solid 0.2 noborder
set autoscale xfix
plot "TCP_2_st_2020_10_18_01-36-23_two2one_iperf_summary.dat" using ($1 >= 0 ? $2 : 1/0):($3/rf-$4/rf):($3/rf+$4/rf) with filledcurves lc rgb "blue" notitle, \
