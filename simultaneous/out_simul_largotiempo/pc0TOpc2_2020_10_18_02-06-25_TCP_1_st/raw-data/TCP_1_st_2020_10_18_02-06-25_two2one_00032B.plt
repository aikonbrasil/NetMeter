...
set output "TCP_1_st_2020_10_18_02-06-25_two2one_00032B.png"

set title "{/=20 Buffer size: 32 B, Av. rate: 8.26 Mb/s}\n\n{/=18 (LAPTOP-UE-2 to LAPTOP-UE-0, TCP, 1 st.)}"
...
set autoscale xfix
plot "TCP_1_st_2020_10_18_02-06-25_two2one_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
