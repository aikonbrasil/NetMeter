...
set output "UDP_4_st_2020_10_18_02-06-25_two2one_00032B.png"

set title "{/=20 Datagram size: 32 B, Av. rate: 341.22 Kb/s}\n\n{/=18 (LAPTOP-UE-1 to LAPTOP-UE-0, UDP, 4 st.)}"
...
set autoscale xfix
plot "UDP_4_st_2020_10_18_02-06-25_two2one_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
