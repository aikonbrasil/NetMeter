...
set output "UDP_1_st_2020_10_14_15-22-50_two2one_summary.png"

set title "{/=20 Bandwidth \\& CPU usage for different packet sizes}\n\n{/=18 (LAPTOP-UE-4 to LAPTOP-UE-1, UDP, 1 st.)}"
...
rf = 1.0  # rate factor
stats "UDP_1_st_2020_10_14_15-22-50_two2one_iperf_summary.dat" using ($1 >= 0 ? $3 : 1/0) nooutput
set logscale x 2
set style fill transparent solid 0.2 noborder
set autoscale xfix
plot "UDP_1_st_2020_10_14_15-22-50_two2one_iperf_summary.dat" using ($1 >= 0 ? $2 : 1/0):($3/rf-$4/rf):($3/rf+$4/rf) with filledcurves lc rgb "blue" notitle, \
