...
set output "TCP_4_st_2020_10_18_09-41-26_two2one_00032B.png"

set title "{/=20 Buffer size: 32 B, Av. rate: 4.43 Mb/s}\n\n{/=18 (LAPTOP-UE-1 to LAPTOP-UE-0, TCP, 4 st.)}"
...
set autoscale xfix
plot "TCP_4_st_2020_10_18_09-41-26_two2one_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
