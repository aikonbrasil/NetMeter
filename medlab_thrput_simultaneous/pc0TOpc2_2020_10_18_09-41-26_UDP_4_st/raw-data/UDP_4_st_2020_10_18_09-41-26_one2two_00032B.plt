...
set output "UDP_4_st_2020_10_18_09-41-26_one2two_00032B.png"

set title "{/=20 Datagram size: 32 B, Av. rate: 426.72 Kb/s}\n\n{/=18 (LAPTOP-UE-0 to LAPTOP-UE-2, UDP, 4 st.)}"
...
set autoscale xfix
plot "UDP_4_st_2020_10_18_09-41-26_one2two_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
