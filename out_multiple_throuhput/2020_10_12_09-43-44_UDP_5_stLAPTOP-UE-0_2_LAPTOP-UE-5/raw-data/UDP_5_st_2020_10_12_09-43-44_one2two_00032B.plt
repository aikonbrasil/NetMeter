...
set output "UDP_5_st_2020_10_12_09-43-44_one2two_00032B.png"

set title "{/=20 Datagram size: 32 B, Av. rate: 2.62 Mb/s}\n\n{/=18 (LAPTOP-UE-0 to LAPTOP-UE-5, UDP, 5 st.)}"
...
set autoscale xfix
plot "UDP_5_st_2020_10_12_09-43-44_one2two_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
