...
set output "TCP_1_st_2020_11_06_01-06-41_two2one_summary.png"
...
rf = 1.0  # rate factor
stats "TCP_1_st_2020_11_06_01-06-41_two2one_iperf_summary.dat" using ($1 >= 0 ? $3 : 1/0) nooutput
set logscale x 2
set style fill transparent solid 0.2 noborder
set autoscale xfix
plot "TCP_1_st_2020_11_06_01-06-41_two2one_iperf_summary.dat" using ($1 >= 0 ? $2 : 1/0):($3/rf-$4/rf):($3/rf+$4/rf) with filledcurves lc rgb "blue" notitle, \
