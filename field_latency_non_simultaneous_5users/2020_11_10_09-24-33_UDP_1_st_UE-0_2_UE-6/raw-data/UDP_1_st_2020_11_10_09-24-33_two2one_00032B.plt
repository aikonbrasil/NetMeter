...
set output "UDP_1_st_2020_11_10_09-24-33_two2one_00032B.png"

set title "{/=20 Datagram size: 32 B, Av. rate: 21.43 ms}\n\n{/=18 (LAPTOP-UE-6 to LAPTOP-UE-0, UDP, 1 st.)}"
...
set autoscale xfix
plot "UDP_1_st_2020_11_10_09-24-33_two2one_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
