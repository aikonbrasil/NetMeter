...
export_dir = 'field_ping_nonsimul_5users'

# IPs of the clients for connection. [str]
# Example: '10.0.1.114'
cl1_conn_ip = '100.100.100.10'
cl2_conn_ip = '192.168.541.11'
cl3_conn_ip = '192.168.541.12'
cl4_conn_ip = '192.168.541.13'
cl5_conn_ip = '192.168.541.14'
cl6_conn_ip = '192.168.541.15'

# IPs of the clients for testing (may use the same as for connection). [str]
# Example: '192.168.100.11'
cl1_test_ip = '100.100.100.10'
cl2_test_ip = '192.168.541.11'
cl3_test_ip = '192.168.541.12'
cl4_test_ip = '192.168.541.13'
cl5_test_ip = '192.168.541.14'
cl6_test_ip = '192.168.541.15'
...
creds_cl5 = 'creds9.dat'
creds_cl6 = 'creds10.dat'
...
title = 'isolated measurement per link'
...
cl5_pretty_name = 'LAPTOP-UE-9'
cl6_pretty_name = 'LAPTOP-UE-10'
