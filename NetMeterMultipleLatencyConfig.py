...
#export_dir = 'field_thrput_non_simulatenous'
export_dir = 'field_latency_non_simultaneous_5users'
...
cl5_conn_ip = '192.168.241.14'
cl6_conn_ip = '192.168.241.15'
...
cl5_test_ip = '192.168.241.14'
cl6_test_ip = '192.168.241.15'
...
#protocols = ['TCP', 'UDP']
# if PANDABOARD is being used, only TCP is ok for TROUGHPUT test.
protocols = ['TCP']
