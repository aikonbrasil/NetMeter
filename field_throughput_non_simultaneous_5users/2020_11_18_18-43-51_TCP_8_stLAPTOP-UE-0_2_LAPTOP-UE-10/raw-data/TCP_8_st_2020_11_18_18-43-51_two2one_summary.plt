...
set output "TCP_8_st_2020_11_18_18-43-51_two2one_summary.png"

set title "{/=20 Bandwidth \\& CPU usage for different packet sizes}\n\n{/=18 (LAPTOP-UE-10 to LAPTOP-UE-0, TCP, 8 st.)}"
...
stats "TCP_8_st_2020_11_18_18-43-51_two2one_iperf_summary.dat" using ($1 >= 0 ? $3 : 1/0) nooutput
set logscale x 2
set style fill transparent solid 0.2 noborder
set autoscale xfix
plot "TCP_8_st_2020_11_18_18-43-51_two2one_iperf_summary.dat" using ($1 >= 0 ? $2 : 1/0):($3/rf-$4/rf):($3/rf+$4/rf) with filledcurves lc rgb "blue" notitle, \
     "" using 2:($1 == 0 ? $3/rf : 1/0):xtic(printxsizes($2)) with points pt 2 ps 1.5 lw 3 lc rgb "magenta" title "Approx. BW", \
     "" using 2:($1 >= 0 ? $3/rf : 1/0):(sprintf("%.2f Kb/s", $3/rf)) with labels offset 0.9,1.0 rotate by 90 font ",12" notitle, \
