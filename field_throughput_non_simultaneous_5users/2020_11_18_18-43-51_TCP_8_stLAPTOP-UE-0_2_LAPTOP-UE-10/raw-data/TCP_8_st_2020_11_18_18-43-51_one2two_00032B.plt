...
set output "TCP_8_st_2020_11_18_18-43-51_one2two_00032B.png"

set title "{/=20 Buffer size: 32 B, Av. rate: 4.16 Mb/s}\n\n{/=18 (LAPTOP-UE-0 to LAPTOP-UE-10, TCP, 8 st.)}"
...
set autoscale xfix
plot "TCP_8_st_2020_11_18_18-43-51_one2two_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
