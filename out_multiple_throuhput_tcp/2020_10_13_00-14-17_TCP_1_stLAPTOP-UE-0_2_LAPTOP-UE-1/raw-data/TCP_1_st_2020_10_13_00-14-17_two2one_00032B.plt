...
set output "TCP_1_st_2020_10_13_00-14-17_two2one_00032B.png"
...
set autoscale xfix
plot "TCP_1_st_2020_10_13_00-14-17_two2one_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
