...
set output "UDP_1_st_2020_10_13_11-45-23_one2two_summary.png"
...
rf = 1.0  # rate factor
stats "UDP_1_st_2020_10_13_11-45-23_one2two_iperf_summary.dat" using ($1 >= 0 ? $3 : 1/0) nooutput
set logscale x 2
set style fill transparent solid 0.2 noborder
set autoscale xfix
plot "UDP_1_st_2020_10_13_11-45-23_one2two_iperf_summary.dat" using ($1 >= 0 ? $2 : 1/0):($3/rf-$4/rf):($3/rf+$4/rf) with filledcurves lc rgb "blue" notitle, \
     "" using 2:($1 == 0 ? $3/rf : 1/0):xtic(printxsizes($2)) with points pt 2 ps 1.5 lw 3 lc rgb "magenta" title "Approx. BW", \
     "" using 2:($1 >= 0 ? $3/rf : 1/0):(sprintf("%.2f b/s", $3/rf)) with labels offset 0.9,1.0 rotate by 90 font ",12" notitle, \
