...
set output "UDP_1_st_2020_10_13_11-45-23_one2two_00032B.png"

set title "{/=20 Datagram size: 32 B, Av. rate: 18.57 b/s}\n\n{/=18 (LAPTOP-UE-0 to LAPTOP-UE-1, UDP, 1 st.)}"
...
set autoscale xfix
plot "UDP_1_st_2020_10_13_11-45-23_one2two_00032B_iperf_processed.dat" using 1:($2/rf-$3/rf):($2/rf+$3/rf) with filledcurves lc rgb "blue" notitle, \
